...
#define E1000_TDBASE_TRANSMIT  0x9000000000
#define E1000_TDBASE_RECEIVE   0x9000001000
#define E1000_PACKET           0x9000002000
#define E1000_PACKET_RECEIVE   (0x9000002000 + TD_MAX * PGSIZE)
