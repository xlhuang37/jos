...
#define VMCS_PIN_BASED_VMEXEC_CTL_DEFAULT1	        0x16
#define VMCS_PIN_BASED_VMEXEC_CTL_EXINTEXIT	         0x1
#define VMCS_PIN_BASED_VMEXEC_CTL_NMI_EXITING	         0x8
#define VMCS_PIN_BASED_VMEXEC_CTL_VIRTUAL_NMIS	        0x20
#define VMCS_PIN_BASED_VMEXEC_CTL_VMX_PREEMPTION_TIMER  0x40
#define VMCS_PIN_BASED_VMEXEC_CTL_PROCESS_POSTED_INT	0x80
...
#define VMCS_PROC_BASED_VMEXEC_CTL_ACTIVE_TERTIARY_CONTROLS 0x20000
#define VMCS_PROC_BASED_VMEXEC_CTL_CR8LOADEXIT	            0x80000
#define VMCS_PROC_BASED_VMEXEC_CTL_CR8STOREEXIT	           0x100000
#define VMCS_PROC_BASED_VMEXEC_CTL_USE_TPR_SHADOW          0x200000
#define VMCS_PROC_BASED_VMEXEC_CTL_NMI_WINDOW_EXITING      0x400000
...
#define VMCS_PROC_BASED_VMEXEC_CTL_USE_MSR_BITMAP        0x10000000
...
// Default 1 bits:  1, 4–6, 8, 13–16, and 26
#define VMCS_PROC_BASED_VMEXEC_CTL_DEFAULT1     ((1<<1) | (1<<4) | (1<<5) \
						 | (1 << 6) | (1 << 8) | (1 << 13)  \
						 | (1 << 14) | (1 << 15) | (1 << 16) \
						 | (1 << 26))

#define VMCS_SECONDARY_VMEXEC_CTL_VIRTUALIZE_APIC      0x1
#define VMCS_SECONDARY_VMEXEC_CTL_ENABLE_EPT           0x2
#define VMCS_SECONDARY_VMEXEC_CTL_VIRTUALIZE_X2APIC   0x10
#define VMCS_SECONDARY_VMEXEC_CTL_ENABLE_VPID         0x20
#define VMCS_SECONDARY_VMEXEC_CTL_UNRESTRICTED_GUEST  0x80
#define VMCS_SECONDARY_VMEXEC_CTL_APIC_REGISTER_VIRT 0x100
#define VMCS_SECONDARY_VMEXEC_CTL_VIRT_INTERRUPT     0x200

/* VM Exit control bits */
// Default 1 bits:  0-7 (0xFF) + 8, 10, 11 (D), 13, 14 (6), 16, 17 (3)
#define VMCS_VMEXIT_DEFAULT1                        0x36DFF
#define VMCS_VMEXIT_HOST_ADDR_SIZE               (0x1 << 9)
#define VMCS_VMEXIT_LOAD_PERF_GLOBAL_CTRL       (0x1 << 12)
#define VMCS_VMEXIT_GUEST_ACK_INTR_ON_EXIT      (0x1 << 15)
#define VMCS_VMEXIT_LOAD_IA32_PAT               (0x1 << 19)
#define VMCS_VMEXIT_SAVE_IA32_EFER              (0x1 << 20)
#define VMCS_VMEXIT_LOAD_IA32_EFER              (0x1 << 21)
#define VMCS_VMEXIT_SAVE_VMX_PREEMPTION_TIMER   (0x1 << 22)
#define VMCS_VMEXIT_LOAD_CET_STATE              (0x1 << 28)
#define VMCS_VMEXIT_LOAD_PKRS                   (0x1 << 29)

/* VM Entry control bits */
#define VMCS_VMENTRY_x64_GUEST              (0x1 << 9)
#define VMCS_VMENTRY_SMM                   (0x1 << 10)
#define VMCS_VMENTRY_DEACTIVATE_DUAL       (0x1 << 11)
#define VMCS_VMENTRY_LOAD_PERF_GLOBAL_CTRL (0x1 << 13)
#define VMCS_VMENTRY_LOAD_EFER             (0x1 << 15)
...
/* If a VMLAUNCH fails, the exit reason is interpreted differently */
#define VMLAUNCH_FAIL_INVALID_CONTROL_FIELDS     0x7
#define VMLAUNCH_FAIL_INVALID_HOST_STATE_FIELDS  0x8
